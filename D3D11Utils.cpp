...
void D3D11Utils::CreateDepthBuffer(ComPtr<ID3D11Device> &device, int screenWidth, int screenHeight,
    ...
    ThrowIfFailed(device->CreateDepthStencilView(depthStencilBuffer.Get(), 0,
